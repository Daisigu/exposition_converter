<template>
    <div class="grid place-items-center">
        <div class="flex flex-col items-center gap-2 w-full">
            <div class="w-full">
                <h2 class="text-center mb-5 text-2xl">Convert pdf to jpg images, and rename to 1.jpg 2.jpg n.jpg...</h2>
                <div class="flex items-center justify-center w-full mb-3">
                    <div v-bind="getRootProps()"
                        ...
                        <input  v-bind="getInputProps()" multiple id="dropzone-file"
            ...
            <a :class="{'pointer-events-none opacity-60 select-none': isButtonDisabled}"
               href="/convertedArchive/pdfToImages/uploads.zip" target="_blank" type="button"
...
const onDrop = async (acceptFiles: FileList, rejectReasons: any) => {
    ...
    formData.append('pptxFile', acceptFiles[0])
    await useFetch('/api/convert', {
        method: 'POST',
        body: formData
    })
    await useFetch('/api/archivateFiles', {
        method: 'POST',
